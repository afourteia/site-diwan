...
export const ui = {
  en: {
    ...
    'home.values.detail': 'We combine decades of experience with transparent processes to keep every exchange clear and compliant.',
    'home.trust.title': 'Our Pillars',
    'home.trust.detail1': 'Licensed and insured currency exchange with transparent rates.',
    'home.trust.detail2': 'Dedicated relationship managers for corporate and retail clients.',
    'home.trust.detail3': '24/7 monitoring with daily settlement reports for peace of mind.',
  ...
  ar: {
    ...
    'home.values.detail': 'نجمع بين خبرة طويلة وإجراءات شفافة لنضمن لكل عملية صرف وضوحاً والتزاماً كاملاً.',
    ...
    'home.trust.detail3': 'متابعة على مدار الساعة مع تقارير تسوية يومية لراحة البال.',
    'about.title': 'من نحن',
